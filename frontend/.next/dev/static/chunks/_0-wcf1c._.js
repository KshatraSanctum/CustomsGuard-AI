...
function EnterpriseCustomsDashboard() {
    ...
    const [description, setDescription] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Industrial catalyst compound containing Vanadium Pentoxide V2O5 for chemical processing");
    ...
    const [structuredData, setStructuredData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    // Mock chat state for the Co-pilot
    ...
    const handleExtract = async (e)=>{
        ...
        setStructuredData(null); // Clear previous data
        ...
        try {
            ...
            setStructuredData(data.structured_data); // Save the smart data
            setChatLog((prev)=>[
                    ...prev,
                    {
                        role: "ai",
                        text: "Document scanned successfully. I've extracted the raw text and mapped the structured shipping data. Would you like me to run the compliance audit?"
                    }
                ]);
        } catch (err) {
    ...
    const handleAudit = async (e)=>{
        ...
        try {
            // Simulate enterprise backend operations for visual impact
    ...
    const handleChatSubmit = async (e)=>{
        ...
        try {
            const res = await fetch("http://127.0.0.1:8000/v1/copilot", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            setChatLog((prev)=>[
                    ...
                    {
                        role: "ai",
                        text: "Error: Unable to reach the AI customs broker backend."
                    }
                ]);
        }
    };
    const handleExportPDF = ()=>{
        ...
        doc.text("CustomsGuard Enterprise Audit Report", 20, 20);
        // Metadata
        doc.setFontSize(10);
        doc.setTextColor(100, 116, 139);
        doc.text(`Generated On: ${new Date().toLocaleString()}`, 20, 28);
        doc.text("Engine: Autonomous Compliance & Risk Mitigation", 20, 34);
        // Divider Line
        ...
        doc.text("1. Item Description & Context", 20, 50);
        doc.setFont("helvetica", "normal");
        doc.setFontSize(10);
        doc.setTextColor(51, 65, 85);
        const splitDescription = doc.splitTextToSize(description || "No description provided.", 170);
        doc.text(splitDescription, 20, 58);
        // Audit Results (if available)
        let nextY = 58 + splitDescription.length * 6 + 10;
        doc.setFont("helvetica", "bold");
        doc.setFontSize(12);
        doc.setTextColor(15, 23, 42);
        doc.text("2. Compliance & Vector Analysis", 20, nextY);
        doc.setFont("helvetica", "normal");
        doc.setFontSize(10);
        doc.text(`Predicted HS Code: ${auditResult ? auditResult.matched_hs_code : "Pending Audit"}`, 20, nextY + 8);
        doc.text(`Compliance Risk Level: ${auditResult ? auditResult.compliance_risk : "N/A"}`, 20, nextY + 14);
        doc.text(`Fraud / Evasion Risk Score: ${auditResult ? auditResult.fraud_score + "%" : "N/A"}`, 20, nextY + 20);
        doc.text(`Sanctions Status: ${auditResult ? auditResult.sanctions_status : "N/A"}`, 20, nextY + 26);
        doc.text(`Duty Estimate: ${auditResult ? auditResult.duty_estimate : "N/A"}`, 20, nextY + 32);
        if (auditResult && auditResult.official_description) {
            nextY += 40;
            doc.setFont("helvetica", "bold");
            doc.text("3. WCO Official Harmonized Description", 20, nextY);
            doc.setFont("helvetica", "normal");
            const splitWCO = doc.splitTextToSize(auditResult.official_description, 170);
            doc.text(splitWCO, 20, nextY + 6);
        }
        // Footer
        doc.setFontSize(8);
        doc.setTextColor(150, 150, 150);
        doc.text("Confidential Enterprise Customs Report - Generated via CustomsGuard AI", 20, 285);
        // Save PDF
        doc.save("CustomsGuard_Audit_Report.pdf");
    };
    // Helper function to render clean formatted text from AI markdown
    const renderFormattedText = (text)=>{
        return text.split("\n").map((line, i)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: trimmed.split("**").map((chunk, index)=>index % 2 === 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        filePreview ? file?.type === "application/pdf" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "text-center p-6 z-10 flex flex-col items-center",
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-sm text-slate-200 font-semibold truncate max-w-[200px]",
                                                    children: file.name
                                                }, void 0, false, {
                                                    fileName: "[project]/app/page.tsx",
                                                    lineNumber: 281,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "PDF Document Ready for Extraction"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/page.tsx",
                                                    lineNumber: 282,
                                                    columnNumber: 22
                                            ...
                                            className: "absolute inset-0 w-full h-full object-contain opacity-60 group-hover:opacity-100 transition duration-300"
                                        }, void 0, false, {
                                            fileName: "[project]/app/page.tsx",
                                            lineNumber: 285,
                                            columnNumber: 19
                                ...
                                structuredData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        activeTab === "audit" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            children: "Extracted Item Description"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/app/page.tsx",
                                                                            lineNumber: 355,
                                                                            columnNumber: 25
                                                ...
                                                (loading || auditLogs.length > 0) && !auditResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        auditLogs.map((log, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: `text-xs font-bold mt-1 flex justify-center items-center gap-1 ${auditResult.sanctions_status === "CLEAR" ? "text-emerald-400" : "text-red-400"}`,
                                                                            children: [
                                                                                auditResult.sanctions_status === "CLEAR" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle2$3e$__["CheckCircle2"], {
                                                                                    className: "w-3 h-3"
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/app/page.tsx",
                                                                                    lineNumber: 420,
                                        ...
                                        activeTab === "copilot" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-col h-full animate-in fade-in duration-300",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex-1 space-y-4 pb-4 overflow-y-auto",
                                                    children: chatLog.map((msg, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                ...
                                                                placeholder: "Ask the co-pilot to clarify duty rates or resolve ambiguities...",
                                                                className: "flex-1 bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-sm text-slate-200 focus:outline-none focus:border-indigo-500"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/page.tsx",
                                                                lineNumber: 451,
                                                                columnNumber: 23
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                type: "submit",
                                                                className: "bg-indigo-600 hover:bg-indigo-500 px-4 rounded-lg font-semibold text-sm transition",
                                                                children: "Send"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/page.tsx",
                                                                lineNumber: 458,
...
_s(EnterpriseCustomsDashboard, "2XYQgdGmn2Ny78i1z0b03+JTNsE=");
_c = EnterpriseCustomsDashboard;
var _c;
__turbopack_context__.k.register(_c, "EnterpriseCustomsDashboard");
...
//# sourceMappingURL=_0-wcf1c._.js.map